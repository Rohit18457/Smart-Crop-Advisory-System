-- ============================================================
-- Smart Agriculture Advisory - Database Functions Migration (FIXED)
-- ============================================================
...
-- Success message
SELECT 'All functions and triggers created successfully! Database is fully enhanced.' as status;